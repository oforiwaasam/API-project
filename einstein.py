...
dict = details.json() #dictionary of einstein quotes
quotes_info = dict['results'] # list of famous quotes with details
...
quotes_df.to_sql('einstein_table', con = engine, if_exists = 'replace', index = False)